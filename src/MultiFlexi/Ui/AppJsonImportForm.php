 ...
 * @author vitex
 */
class AppJsonImportForm extends \Ease\TWB5\Form
{
    public function __construct(array $formProperties = [], array $formDivProperties = [], $formContents = null)
    {
        ...
        $this->addItem(new \Ease\TWB5\SubmitButton(_('Import Json'), 'primary', ['title' => _('Import Application from JSON file'), 'id' => 'importappjsonbutton']));
    }
}
